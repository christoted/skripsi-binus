                ...
                tab?.position.let { position ->
                    with(binding) {
                        ...
                        flScore.updateLayoutParams {
                            height =
                                if (position == PrProgressViewModel.VIEW_TYPE_SCORE) circleExpand else circleShrink
                        }
                        flAttendance.updateLayoutParams {
                            height =
                                if (position == PrProgressViewModel.VIEW_TYPE_ATTENDANCE) circleExpand else circleShrink
                        }
                        flAchievement.updateLayoutParams {
                            height =
                                if (position == PrProgressViewModel.VIEW_TYPE_ACHIEVEMENT) circleExpand else circleShrink
                        }
                    }
                }
            }
